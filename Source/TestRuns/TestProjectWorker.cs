...
namespace TestRuns
{
    ...
    /// </summary>
    public class TestProjectWorker : Repeater
    {
        #region Constants
        ...
        // Test related files
        private const string TESTPROJECT_WORKER_LOG_FILE = "TestProjectWorkerLog.txt";
        public static string TEST_CENTER_LOG_FILE = TESTPROJECT_WORKER_LOG_FILE;
        public static string TEST_RESULT_FILE_SURFIX = "-FuncTest-";
        ...
        protected override void OnActivate()
        {
            ...
            sTestCaseName[34] = "TS300026TransOrderSuspendAllPending";
            sTestCaseName[35] = "TS300030TransOrderReleaseAllPending";
            sTestCaseName[36] = "TS350057MutexAuto";
            sTestCaseName[37] = "TS300016TransportSourceVia";
            sTestCaseName[38] = "TS300017TransportDestinationVia";
            sTestCaseName[39] = "TS241099WeekPlanBatteryCharge";
            sTestCaseName[40] = "TS241047WeekPlanBatteryChargeDisable";
            sTestCaseName[41] = "TS241048WeekPlanBatteryChargeDisableAll";
            sTestCaseName[42] = "TS241049WeekPlanBatteryChargeDelete";
            sTestCaseName[43] = "TS242099WeekPlanCalibration";
            sTestCaseName[44] = "TS242047WeekPlanCalibrationDisable";
            sTestCaseName[45] = "TS242048WeekPlanCalibrationDisableAll";
            sTestCaseName[46] = "TS242049WeekPlanCalibrationDelete";
            sTestCaseName[47] = "TS200083AgvStop";
            sTestCaseName[48] = "TS200071AgvState";
            sTestCaseName[49] = "TS200037AgvRetire";
            sTestCaseName[50] = "TS200053AgvDeploy";
            sTestCaseName[51] = "TS200023AgvSuspend";
            sTestCaseName[52] = "TS200027AgvRelease";
            sTestCaseName[53] = "TS200012AgvModeRemoved";
            sTestCaseName[54] = "TS200014AgvModeRemovedAll";
            sTestCaseName[55] = "TS200047AgvModeDisable";
            sTestCaseName[56] = "TS200048AgvModeDisableAll";
            sTestCaseName[57] = "TS200058AgvModeSemiAutomatic";
            sTestCaseName[58] = "TS200061AgvModeSemiAutomaticAll";
            sTestCaseName[59] = "TS309306TransPickDeactiveRestart";
            sTestCaseName[60] = "TS420047LocationDisable";
            sTestCaseName[61] = "TS420045LocationManual";
            sTestCaseName[62] = "TS460047StationDisable";
            sTestCaseName[63] = "TS400034LoadFlushAndDiscard";
            sTestCaseName[64] = "TS400076LoadDiscard";
            sTestCaseName[65] = "TS305513TransOrderDelay";
            sTestCaseName[66] = "TS305514TransOrderDivert";
            sTestCaseName[67] = "TS304455LocationClosestHighest";
            sTestCaseName[68] = "TS304457GroupHighestPriority";
            sTestCaseName[69] = "TS304456LoadClosestHighest";
            sTestCaseName[70] = "TS305501OrderAssignmentClosest";
            sTestCaseName[71] = "TS305502TransOrderClosest";
            sTestCaseName[72] = "TS305503OrderAssignmentClosestHighest";
            sTestCaseName[73] = "TS305504TransOrderClosestHighest";
            sTestCaseName[74] = "TS305505TransOrderOldest";
            sTestCaseName[75] = "TS305507SchedulesDeadlockRulesVia";
            sTestCaseName[76] = "TS305508ScheduleBattRulesQueueSimLow";
            sTestCaseName[77] = "TS330056RoutingDynamic";
            sTestCaseName[78] = "TS300080TransPickFromGroup";
            sTestCaseName[79] = "TS300081TransDropToGroup";
            sTestCaseName[80] = "TS200080AgvModeSemiToAuto";
            ...
            if (m_Project.ID.ToString().ToUpper().StartsWith("EUROBALTIC"))
            {
                ...
                TEST_RESULT_FILE_SURFIX = "-FuncTest-Eurobaltic-";
                sProjectID = TestConstants.PROJECT_EUROBALTIC;
            }
            else if (m_Project.ID.ToString().ToUpper().StartsWith("TESTPROJECT"))
            {
                TEST_CENTER_LOG_FILE = TESTPROJECT_WORKER_LOG_FILE;
                if (testinfo.autoTestMode_15)
                    TEST_RESULT_FILE_SURFIX = "-TestProject-";
                else
                    TEST_RESULT_FILE_SURFIX = "-Manual-TestProject-";
            ...
            //sDemo = m_Project.Facilities["Tests"].Parameters["Demo"].ValueAsString;
            //sExcelShow = m_Project.Facilities["Tests"].Parameters["ExcelVisible"].ValueAsBool;
            ...
            mLogger.LogMessageToFile("ExcelVisible  " + testinfo.excelShow_11);
            mLogger.LogMessageToFile("Demo  " + testinfo.demo_9);
                ...
                if (sRunStatus.Equals("StartRunning"))
                {
                    switch (sCounter)
                    {
                        ...
                        case 34:
                            ...
                            break;
                        case 35: // pre-condition should run after TS300026TransOrderSuspendAllPending
                            //sTestData = false;
                            //mTestAgv = m_Agv11;
                        ...
                        case 75: // deadlock via		
                            ...
                            break;
                        case 76: // battery low set to true		
                            //sTestData = false;
                            //sSourceID = "0030-03-01";
                            //sDestinationID = "0360-01-01";
                            //sSource2ID = "0030-01-01";
                        ...
                        case 77:
                            ...
                            //   break;
                            //case 83:	// double play	Transport released
                            //sTestData = false;
                            //sSourceID = "0240-01-01";
        ...
        private void TS220001JobParkSemiAutomatic(string sTSName)
        {
            try
            {
                ...
                {
                    //if (sDemo.ToLower().ToString().StartsWith("true"))
        ...
        private void TestScenario_TS220023JobSuspending(string sTSName)
        {
            try
            {
                ...
                if (mTestStatus == TestConstants.TEST_RUNS5)
                {
                    ...
                    if (mTime.TotalMilliseconds >= 2000) // Wait 2 sec.
                    {
                        mMsg = m_Job3.ID + " suspend is : " + m_Job2.Suspended;
                        if (m_Job3.Suspended)
                        {
                            sTestResult = TestConstants.TEST_PASS;
                            mLogger.LogPassLine(mMsg);
                ...
                if (mTestStatus == TestConstants.TEST_RUNS6)
                {
                    ...
                    {
                        sAgvCurrentLSID = sTestAgvs[0].CurrentLSID.ToString();
                        mMsg = "after 10 sec " + sTestAgvs[0].ID + " current lsid id:: " + sAgvCurrentLSID;
                        mLogger.LogPassLine(mMsg);

                        m_Job2.Release();
                        mLogger.LogMessageToFile(m_Job2.ID + " is released");
            ...
            try
            {
                ...
                if (mTestStatus == TestConstants.TEST_RUNS4)
                {
                    ...
                    if (mTime.TotalMilliseconds >= 3000) // Wait 3 sec.
                    {
                        ...
                        TestUtility.RemoteLogPassLine("job released", sTestMonitorUsed, m_Project);
                        m_Job2.Release();
                        sTestStartTime = DateTime.Now;
                        mRunStatus = TestConstants.CONTINUE;
                        mTestStatus = TestConstants.TEST_RUNS5;
                ...
                // (9)	Wait until 0360-01-01 is locked by Agv11 
                // (10)	Suspend JobB
                if (mTestStatus == TestConstants.TEST_RUNS5)
                {
                    TestUtility.WaitUntilAgvLockLSID(ref mRunStatus, sTestAgvs[0], sDestinationID + ".DROP",
        ...
        public void TestScenario_TS300017TransportDestinationVia(string sTSName)
        {
            try
            {
                ...
                if (mTestStatus == TestConstants.TEST_RUNS2)
                {
                    ...
                    else if (mTime.TotalMilliseconds >= 3*sWaitTime*60*1000) //  3*waitTime min
                    {
            ...
            try
            {
                ...
                if (mTestStatus == TestConstants.TEST_STARTING)
                {
                    ...
                    else
                    {
                        ...
                        {
                            mMsg = "After 3 min no batt job created";
                            sTestResult = TestConstants.TEST_FAIL;
                            mLogger.LogFailLine(mMsg);
                            TestUtility.RemoteLogFailLine(mMsg, sTestMonitorUsed, m_Project);
                            mTestStatus = TestConstants.TEST_FINISHED;
        ...
        private void TestScenario_TS200061AgvModeSemiAutomaticAll(string sTSName)
        {
            try
            {
                ...
                //4.	Wait until TransportA and TransportB state RETRIEVED 
                if (mTestStatus == TestConstants.TEST_RUNS)
                {
                    TestUtility.WaitUntilTransportState(ref mRunStatus, m_Transport, sTestStartTime, sWaitTime,
                                                        Transport.STATE.RETRIEVED,
        ...
        */
        protected void EndTestCase(string sTSName, int result, ref string testData)
        {
            if (sTestID == 0)
            {
                try
                {
                    ...
                    mLogger.LogMessageToFile("\tEnd Case(" + sCounter + ")-----  Test " + sTSName +
                                             " :   end :next one ");
                    mLogger.LogMessageToFile(" ");
                    ...
                    // =================    Log Agvs Positions of previous test cqse ==============
                    for (int i = 0; i < sTestAgvs.Length; i++)
                    {
                        if (sTestAgvs[i] != null)
                        {
        ...
        protected void EndTestCaseAndUpdateFiles(string sTSName, int result, ref string testData)
        {
                ...
                if (mTime.TotalMilliseconds >= 3000) // 3 second
                {
                    ...
                    if (sTestID == 0)
                    {
                        ...
                        try
                        {
                            ...
                            string xPath = DateTime.Now.ToString("yyyyMMdd-HH-mm-ss") + TEST_RESULT_FILE_SURFIX
                                           + Environment.MachineName;

                            string xNameXLS = xPath + ".xls";
                            xNameLog = xPath + ".log";

                            //string xName = xPath + ".xls";

                            //string root = m_Project.Facilities["Tests"].Parameters["TestCenterRoot"].ValueAsString;
                            sXLSPath = Path.Combine(testinfo.testDirectory_13, xPath + ".xls");
                            mLogger.LogMessageToFile("---> excel file::" + sXLSPath);
                            ...
                            if (testinfo.installedApp_1.Equals("Installed:Etricc 5"))
                            {
                                mLogger.LogMessageToFile("copy excel ---> installed App is:" + testinfo.installedApp_1);

                                #region  // save excel and log to Xdrive only for "Etricc 5"

                                //if (System.Environment.MachineName.StartsWith("EPIATESTPC"))
                                //{
                                int inx = testinfo.buildInstallScriptDir_7.IndexOf("Debug");
                                excelpath = testinfo.buildInstallScriptDir_7.Substring(0, inx - 1) + "\\TestResults";
                                ...
                                CopyResult(testinfo.testDirectory_13, excelpath, xNameXLS);
                                mLogger.LogMessageToFile("test results saved on Marvel_Technologies_server ");
                                mLogger.LogMessageToFile("Copy test log file ==excelpath :" + excelpath);
                                mLogger.LogMessageToFile("Copy test log file TEST_CENTER_LOG_FILE:" +
                                                         TEST_CENTER_LOG_FILE);
                                mLogger.LogMessageToFile("Copy test log file xNameLog:" + xNameLog);
                        ...
                        {
                            //MessageBox.Show("xxxxxxxxx:" + ex.Message, ex.StackTrace, "EndTestCaseAndUpdateFiles:Save xls file");
            ...
            if (mJobStatus == TestConstants.JOB_FINISHED)
            {
                ...
                if (mTime.TotalMilliseconds >= 3000) // 3 second
                {
                    if (sTestID == 0)
                    {
                        ...
                        //    "Functional", ref mLogger, sTotalFailCounter,
                        //    TextStatistics, string.Empty, sSendMail);
                    }
                    sTestStartTime = DateTime.Now;
            ...
            if (mJobStatus == TestConstants.JOB_FINISHED1)
            {
                ...
                if (mTime.TotalMilliseconds >= 3000) // 3 second
                {
                    if (sTestID == 0)
                    {
                        ...
                        while (Marshal.ReleaseComObject(xRange) > 0)
                            xRange = null;
                        while (Marshal.ReleaseComObject(xSheet) > 0)
                            xSheet = null;
                        while (Marshal.ReleaseComObject(xBook) > 0)
                            xBook = null;
                        while (Marshal.ReleaseComObject(xBooks) > 0)
                            xBooks = null;
            ...
            if (mJobStatus == TestConstants.JOB_FINISHED2)
            {
                ...
                if (mTime.TotalMilliseconds >= 3000) // 3 second
                {
                    //string setupinfo = TestUtility.UpdateSetupInfoFile(ref mLogger, sRoot);
        ...
        /// </summary>
        /// <param name="Destination">Full drive path</param>
        private int CreateDriveMap(string Destination)
        {
            if ((Destination == null) || (Destination == ""))
                return -1;
