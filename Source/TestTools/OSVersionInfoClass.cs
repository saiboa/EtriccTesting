...
namespace TestTools
{
    public class OSVersionInfoClass
    {
        ...
        public static string ProgramFilesx86FolderName()
        {
            string foldername = "Program Files";
            if (8 == IntPtr.Size ||
                (!String.IsNullOrEmpty(Environment.GetEnvironmentVariable("PROCESSOR_ARCHITEW6432"))))
            {
                foldername = Environment.GetEnvironmentVariable("ProgramFiles(x86)");
            }
            else
                foldername = Environment.GetEnvironmentVariable("ProgramFiles");


            return foldername.Substring(foldername.IndexOf("Program"));
        }
        ...
        public static class OSVersionInfo
        {
            ...
            #region SoftwareArchitecture enum
            ...
            public static SoftwareArchitecture ProgramBits
            {
                get
                {
                    ...
                    IDictionary test = Environment.GetEnvironmentVariables();
