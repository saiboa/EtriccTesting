...
'application.Parameters("WorkerFilePath").Value = "C:\EtriccTests\TestRuns\bin\Debug\TestRuns.dll"
...
'	TestCenterRootParameter.ValueAsString = "C:\Epia 3\Testing\Automatic\AutomaticTests"
'
...
'-------------------------------
'schedule = project.Schedules("AREA30.DEADLOCK")
'If Not schedule Is Nothing Then
' project.Schedules.Remove( schedule )
'End If
'schedule = New Egemin.EPIA.WCS.Scheduling.Schedule( "AREA30", schedule.TYPE.DEADLOCK )
'rule = New Egemin.EPIA.WCS.Scheduling.Rule()
'rule.Type = rule.TYPE.VIA
'rule.Arguments.Add( "X0500_018" )
'schedule.Rules.Add( rule )
